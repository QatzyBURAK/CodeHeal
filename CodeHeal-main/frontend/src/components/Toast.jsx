 ...
 * - type: string - Type of toast (success, error, info, warning)
...
const Toast = ({ message, type = 'info', onClose, duration = 5000 }) => {
  ...
  return (
    <div className={`fixed top-4 right-4 z-50 max-w-md p-4 rounded-lg border-2 shadow-lg backdrop-blur-sm animate-slide-in ${getTypeStyles()}`}>
